...
- breastSize: female only — physical characteristics only (e.g. Small Breasts, Medium Breasts, Large Breasts, Extra Large Breasts, Huge Breasts) — leave blank if not described. Always "" if character is male.
- bodyType: physical characteristics only (e.g. Slim body, curvy body, athletic body, muscular body) — leave blank if not described. Applies to all genders.
- skin: physical characteristics only (e.g. white skin, brown skin, olive skin, tan skin) — leave blank if not described. Applies to all genders.
