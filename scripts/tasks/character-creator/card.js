...
{{char}}: (She wrenches the blanket fully around herself, shoves past him, and slams the bathroom door; the lock clicks hard.)
"You can stand out there and listen to yourself talk, you absolute creep!"
Note that each repeated demand escalates her expulsion — a firm order, then shouted profanity at her temperament's full intensity, then stopping entirely and removing herself — and at no point does pressure produce compliance, uncovering, or continuing for {{user}}'s benefit.
