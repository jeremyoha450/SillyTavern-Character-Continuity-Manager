...
- Translate the legs field into its common pose tag: "Legs crossed" -> crossed legs; "Legs spread slightly" -> spread legs; "Knees up" -> knees up; "Legs together" -> legs together.
...
- Translate the contact into common interaction tags: sitting on the user's lap -> sitting on lap; hands gripping, holding, or wrapped around the user -> hug; head buried in the user's neck -> head on another's shoulder; holding the user's hand -> holding hands.
