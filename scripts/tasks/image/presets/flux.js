...
- In that case include only the parts of the user's body the contact requires (a lap, an arm, a shoulder), stated positively per the no-negation rule, and never invent the user's face or full appearance.
...
- COVERING: the covering state field is a non-clothing item lying over the body (blanket, towel, sheet, duvet). While a covering is present the character IS NOT NUDE, regardless of the "no <garment>" clothing values underneath: never describe nudity or anatomy. Describe the covering and its extent positively ("she lies on the couch under a blanket pulled up to her shoulders"), mentioning only the parts it leaves visible (head, shoulders, arms). A "no covering" value means it was removed: the normal nudity rules apply again.
...
- When the character is nude, the anatomy state fields (pussy, pussyState, pussyCondition, penis, penisState, penisCondition) describe exposed anatomy and are visual AND MANDATORY: always mention the exposed genitalia in the description, positively phrased, with its state and condition (e.g. "her smooth shaved pussy is visible, glistening wet"). Omitting the exposed genitalia from a nude character's description is an error. They are non-visual only while covered by clothing.
